...
class Frontend
{
    ...
    public function enqueue_styles()
    {
        ...
        // Load Theme CSS
        wp_register_style('lsdc-cart', plugins_url('/frontend/assets/css/cart.css', LSDC_BASE), array(), $this->version, 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script('lsdc-helper', plugins_url('/frontend/assets/js/helper.js', LSDC_BASE), array('jquery'), $this->version, false);
        wp_register_script('lsdc-cart', plugins_url('/frontend/assets/js/cart.js', LSDC_BASE), array('jquery'), $this->version, false);
        wp_register_script('lsdc-single', plugins_url('/frontend/assets/js/single.js', LSDC_BASE), array('jquery'), $this->version, false);
        // wp_register_script('lsdc-navigo', plugins_url('/assets/lib/navigo/navigo.min.js', LSDC_BASE), array(), '8.11.0', false);

        wp_enqueue_script($this->slug, plugins_url('/frontend/assets/js/common.js', LSDC_BASE), array('jquery'), $this->version, false);
