...
class EmailNotification extends Notification_Template
{
    protected $id = 'lsdcommerce_email';
    ...
    public function __construct()
    {
        ...
        // Setter
        $this->settings = get_option($this->id); // lsdcommerce_email
        ...
        // Notification Hook, Every Notification Generate will Call This.
    ...
    {
        if ( $this->status() ) { // Checking Status Notification Enable ?
    ...
    /**
     * Notification Email Manage Settings
     * And Templates.
     *
     * @return void
     */
  ...
  <div class="tab-body-wrapper">
    ...
    <div id="tab-body-1" class="tab-body">
      ...
      <div class="input-group" style="width:50%;">
        <input id="lsdc_email_test" style="margin-top:3px;" class="form-input input-md" type="email"
      ...
      <form class="form-horizontal" block="settings">
        ...
        <div class="form-group">
          ...
          <div class="col-9 col-sm-12">
            <input class="form-input" type="text" name="sender" placeholder="LSDPlugins" style="width:320px"
              value="<?php esc_attr_e(isset($this->sender) ? $this->sender : null);?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-9 col-sm-12">
            <input class="form-input" type="email" name="sender_email" placeholder="info@lsdplugins.com"
              style="width:320px" value="<?php esc_attr_e(isset($this->sender_email) ? $this->sender_email : null);?>">
          </div>
        </div>

        <button class="btn btn-primary lsdc_admin_option_save" option="lsdc_notification_email"
          style="width:120px"><?php _e('Save', 'lsdcommerce');?></button>
      </form>
...
Notification::register("email-notification", new EmailNotification());
?>