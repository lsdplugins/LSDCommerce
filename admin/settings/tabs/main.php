    ...
    <div class="column col-12 col-sm-12 px-0">
        <ul class="tab tab-primary">
            <?php if (  $tab_lists ): ?>
                ...
                <?php endforeach;?>
            <?php endif;?>
            <li class="tab-item <?php if ($active_tab == 'premium') {echo 'active';}?>">
                <a class="" data-badge="10" href="?page=lsdcommerce&tab=premium"><?php _e('Premium', 'lsdcommerce');?></a>
            </li>
        </ul>
    </div>
