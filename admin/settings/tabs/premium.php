...
<div class="columns">
  ...
  <div class="column col-12">
    <div class="empty">
      <div class="empty-icon"><i class="icon icon-3x icon-link"></i></div>
      <p class="empty-title h5">Dapatkan Fitur Premium</p>
      <p class="empty-subtitle">Beli dan Atur Ekstensi Tambahan untuk LSDCommerce</p>
  ...
  <div class="filter columns column col-12" style="display:none;">
