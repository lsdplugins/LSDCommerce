...
class Admin
{
    ...
    public function __construct($slug, $name, $version)
    {
        ...
        // Load Required File
        require_once LSDC_PATH . 'admin/setup/class-setup-wizard.php';
        require_once LSDC_PATH . 'admin/settings/tabs.php';

        require_once LSDC_PATH . 'admin/class-ajax.php';

        require_once LSDC_PATH . 'admin/classes/class-dashboard.php';
        require_once LSDC_PATH . 'admin/classes/class-updater.php';
        // require_once LSDC_PATH . 'admin/utils/class-beta-updater.php';
    }
    ...
    {
        // Redirect to Settings after activate plugin
    ...
    public function enqueue_styles()
    {
        ...
        if (isset($_GET['page'])) {
            if ($_GET['page'] == 'lsdcommerce' || strpos($_GET['page'], 'lsdc-') !== false) {
                ...
                wp_enqueue_style('spectre-exp', LSDC_URL . 'admin/assets/lib/spectre/spectre-exp.min.css', array(), '0.5.8', 'all');
                wp_enqueue_style('spectre-icons', LSDC_URL . 'admin/assets/lib/spectre/spectre-icons.min.css', array(), '0.5.8', 'all');
                wp_enqueue_style('spectre', LSDC_URL . 'admin/assets/lib/spectre/spectre.min.css', array(), '0.5.8', 'all');

                wp_enqueue_style($this->slug, LSDC_URL . 'admin/assets/css/admin-settings' . $dev_css, array(), $this->version, 'all');
                wp_enqueue_style('wp-color-picker');
            }
        }

        if (strpos(get_post_type(get_the_ID()), 'product') !== false) {
            wp_enqueue_style($this->slug . '-product', LSDC_URL . 'admin/assets/css/admin-product' . $dev_css, array(), $this->version, 'all');
        }

        // Global Admin Styles
        wp_enqueue_style($this->slug . '-global', LSDC_URL . 'admin/assets/css/admin-global' . $dev_css, array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'lsdcommerce' || strpos(get_post_type(get_the_ID()), 'lsdc-') !== false || isset($_GET['page']) && strpos($_GET['page'], 'lsdc-') !== false) {
            // Load Admin Js
            wp_enqueue_script($this->slug, LSDC_URL . 'admin/assets/js/admin' . $dev_js, array('jquery', 'wp-color-picker'), $this->version, false);
            ...
            wp_enqueue_script($this->slug . '-common', LSDC_URL . 'admin/assets/js/common' . $dev_js, array('jquery'), $this->version, false);
            wp_localize_script($this->slug. '-common', 'lsdc_admin', array(
                'currency' => lsdc_get_currency(),
            ));
        }   
    }
    ...
    public function register_admin_menu()
    {
        ...
        add_menu_page(
            ...
            LSDC_URL . 'admin/assets/images/lsdcommerce.png',
            45
        );
        ...
        add_submenu_page(
            ...
            __('Toko', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=store',
            ''
        );
        ...
        add_submenu_page(
            ...
            __('Tampilan', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=appearance',
            ''
        );
        ...
        add_submenu_page(
            ...
            __('Notifikasi', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=notifications',
            ''
        );
        ...
        add_submenu_page(
            ...
            __('Pembayaran', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=payments',
            ''
        );
        ...
        add_submenu_page(
            ...
            __('Pengiriman', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=shipping',
            ''
        );
        ...
        add_submenu_page(
            ...
            __('Pengaturan', 'lsdcommerce'),
            'manage_options',
            'admin.php?page=lsdcommerce&tab=settings',
            ''
        );

        add_submenu_page(
            $this->slug,
            '<span class="lsd-premium">' . __('Premium', 'lsdcommerce') . '</span>',
            '<span class="lsd-premium">' . __('Premium', 'lsdcommerce') . '</span>',
            'manage_options',
            'admin.php?page=lsdcommerce&tab=premium',
            ''
        );
        ...
        add_menu_page(
            ...
            '',
            LSDC_URL . 'admin/assets/svg/product.svg',
            50
        );
        ...
        add_menu_page(
            ...
            '',
            LSDC_URL . 'admin/assets/svg/order.svg',
            50
        );
        ...
        require_once LSDC_PATH . 'admin/classes/class-shortcode-lists.php';
        Admin\Shortcode_Lists::addShortcodeList($this->slug, $this->name, array(
            ['shortcode' => '[lsdcommerce_storefront]', 'description' => __("Menampilkan Etalase", 'lsdcommerce')],
        ...
        require_once LSDC_PATH . 'admin/classes/class-switch-options.php';
    ...
    {
        include_once LSDC_PATH . 'admin/settings/tabs/main.php';
    }
