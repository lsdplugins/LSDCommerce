...
lsdc_member_add_tab('dashboard', __('Dasbor', 'lsdcommerce'), function () {
    require_once LSDC_PATH . 'public/templates/storefront/member/dashboard.php';
});

lsdc_member_add_tab('order', __('Pembelian', 'lsdcommerce'), function () {
    require_once LSDC_PATH . 'public/templates/storefront/member/order-history.php';
});

lsdc_member_add_tab('shipping', __('Pengiriman', 'lsdcommerce'), function () {
    require_once LSDC_PATH . 'public/templates/storefront/member/shipping-history.php';
});

lsdc_member_add_tab('profile', __('Profil', 'lsdcommerce'), function () {
    require_once LSDC_PATH . 'public/templates/storefront/member/edit-profile.php';
});
