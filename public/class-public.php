...
class Generic
{
    ...
    public static function register( array $plugin )
    {
        ...
        // add_filter('lsdcommerce/payment/extras', [$public,'set_unique_code']);
    ...
    {
        // Loading Base CSS
        wp_enqueue_style('lsdplugins-core', plugins_url('/public/assets/lib/lsdplugins/lsdplugins.css', LSDC_BASE), array(), '1.0.1', 'all');

        // Load Theme CSS
        wp_register_style('lsdc-cart', plugins_url('/public/assets/css/cart.css', LSDC_BASE), array(), $this->version, 'all');
        wp_register_style('lsdc-single', plugins_url('/public/assets/css/single.css', LSDC_BASE), array(), $this->version, 'all');
        wp_register_style('lsdc-theme', plugins_url('/public/assets/css/theme.css', LSDC_BASE), array(), $this->version, 'all');
        wp_register_style('lsdc-member', plugins_url('/public/assets/css/member.css', LSDC_BASE), array(), $this->version, 'all');
        wp_register_style('lsdc-responsive', plugins_url('/public/assets/css/responsive.css', LSDC_BASE), array(), $this->version, 'all');

        // wp_register_style( 'lsdc-tab-swiper', plugins_url( '/assets/public/css/tab-swiper.css', LSDC_BASE ), array(), $this->version, 'all' );
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script('lsdc-helper', plugins_url('/public/assets/js/helper.js', LSDC_BASE), array('jquery'), $this->version, false);
        wp_register_script('lsdc-cart', plugins_url('/public/assets/js/cart.js', LSDC_BASE), array('jquery'), $this->version, false);
        wp_register_script('lsdc-single', plugins_url('/public/assets/js/single.js', LSDC_BASE), array('jquery'), $this->version, false);
        // wp_register_script('lsdc-navigo', plugins_url('/assets/lib/navigo/navigo.min.js', LSDC_BASE), array(), '8.11.0', false);

        wp_enqueue_script($this->slug, plugins_url('/public/assets/js/common.js', LSDC_BASE), array('jquery'), $this->version, false);
        wp_localize_script($this->slug, '_lsdcommerce', array(
            'plugin_url' => LSDC_URL,
        ...
        //     wp_enqueue_script('lsdc-popup', plugins_url('/assets/public/js/popup.js', LSDC_BASE), array('jquery'), $this->version, false);
        // }

        // wp_register_script( 'swiper', plugins_url( '/assets/lib/swiper/swiper.js', LSDC_BASE ), array( 'jquery' ), '5.3.6', false );
        // wp_register_script( 'lsdc-swiper', plugins_url( '/assets/public/js/main.js', LSDC_BASE ), array( 'jquery' ), $this->version, false );
    }
